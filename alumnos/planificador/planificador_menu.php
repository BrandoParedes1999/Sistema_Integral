...
$nombreAlum  = trim($alumno['nombre'] . ' ' . $alumno['apepa'] . ' ' . $alumno['apema']);
$inicialAvatar = strtoupper(substr($alumno['nombre'], 0, 1));
...
<header class="app-topbar">
    ...
    <div class="user-chip">
        <span class="avatar-user"><?php echo $inicialAvatar; ?></span>
        <span class="user-copy"><?php echo h($nombreAlum); ?></span>
        <div class="user-chip-menu">
            <a class="user-chip-action" href="../inicio.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16"><path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6-.354.354.708.708L3 7.207V13.5A1.5 1.5 0 0 0 4.5 15h3v-4h1v4h3A1.5 1.5 0 0 0 13 13.5V7.207l.354.001.708-.708-.354-.354-6-6z"/></svg>
                Portal
            </a>
            <a class="user-chip-action user-chip-logout" href="../../auth/logoutAlumno.php">
...
<section class="hero-app">
    <div class="hero-copy">
        ...
        <h1>Hola, <?php echo h($alumno['nombre']); ?>.<br>Tu bienestar,<br>tu mejor plan.</h1>
