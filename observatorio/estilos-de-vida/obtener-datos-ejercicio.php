...
// --- DATOS DE EJERCICIO CON FILTROS (OPTIMIZADO) ---
elseif ($tipo == "ejercicio_datos") {
    $where = [];
    $params = [];
    $types = "";
    ...
    $sql = "SELECT 
                ...
                COUNT(*) as cantidad
            FROM ejercicio ej
            INNER JOIN estilo_de_vida e ON ej.id_cuestionario = e.id_cuestionario
            INNER JOIN alumnos a ON e.matricula_alum = a.matricula_alum
            $whereClause
            GROUP BY ej.saludable_ejercicio
            ORDER BY ej.saludable_ejercicio DESC";
...
// --- COMPARACIÓN ENTRE FACULTADES (EJERCICIO) ---
elseif ($tipo == "comparar_facultades_ejercicio") {
    $where = [];
    $params = [];
    $types = "";
    ...
    $sql = "SELECT 
            ...
            $whereClause
            GROUP BY f.nombre_facultad, ej.saludable_ejercicio
            ORDER BY f.nombre_facultad, ej.saludable_ejercicio";
